                    ...
                    return function(t, e, n) {
                        ...
                        value: function(t) {
                            for (var e = [], n = {}, r = 0; r < t.length; r++) {
                                ...
                                if ("WEBRTC_CALL" === p.m && p.md && p.md.webrtc && (f = !0, h = p.md.clid), "n" !== p.t || "WEBRTC_CALL" === p.m) {
                                    ...
                                    u = this.parseText(o.a.rawEncode(o.a.rawDecode(p.m)));
                                    var y = this.parseSurvey(u);
                                    p.md && p.md.file && (g.isUpload = !0, g.humanizeFileSize = i.a.formatFileSize(p.md.file.size), g.fileName = o.a.rawEncode(p.md.file.fileName), g.fileLink = "".concat("https://tawk.link", "/").concat(p.md.file.name), p.md.file.type.match(/(jpg|jpeg|png|gif)$/i) ? g.fileType = "image" : -1 !== ["video/mp4", "video/ogg", "video/webm"].indexOf(p.md.file.mimeType) ? g.fileType = "video" : -1 !== ["audio/mp3", "audio/ogg", "audio/mpeg", "audio/wav"].indexOf(p.md.file.mimeType) && (g.fileType = "audio")), e.push(l(l({}, g), {}, {
                                        timeStamp: w,
                                        message: u,
                                        name: d,
                                        type: p.t,
                        ...
                        value: function(e, n) {
                            ...
                            if ("v" === e.ut) r = this.store.getters["visitor/displayName"], s = e.uid;
                                ...
                                var g = this.store.getters["chat/agents"];
                                g[e.md.rsc] && (s = g[e.md.rsc].profileId);
                        ...
                        value: function(t, e) {
                            ...
                            void 0 !== window.emojione && (t = t.replace(/©/gm, "&copy;").replace(/®/gm, "&reg;").replace(/™/gm, "&trade;"), t = (t = window.emojione.toShort(t)).replace(/&copy;/gm, "©").replace(/'&reg;/gm, "®").replace(/&trade;/gm, "™")), this.sendMessageToServer(t, e)
                        }
                    }, {
                        ...
                        value: function(e) {
                            ...
                            o.length && t.Tawk_Window.eventBus.$emit("tooBigFileList", o), Object(s.a)(i).then((function(e) {
                                for (var i = function() {
                                        var i = e[o];
                                        if ("fulfilled" === i.status && i.value) {
                                            var r = {
                                                fileName: i.value.filename,
                                                name: i.value.name,
                                                type: i.value.extension,
                                                mimeType: i.value.mimeType,
                                                size: i.value.size
                                            };
                                            t.Tawk_Window.app.$socket.publish("fileUploadMessage", r, (function(e, i, o) {
                                                if (!e) {
                                                    ...
                                                    n.store.commit("chat/setOutgoingMessage", a), n.store.dispatch("chat/outgoingChatMessage", a), t.Tawk_Window.jsApi.triggerApiHandlers("onFileUpload", "https://tawkto.link/" + r.name)
                                                }
                                            }))
                                        } else {
                ...
                function(t) {
                    ...
                    function o() {
                        ...
                        var v = Object.getPrototypeOf,
                            y = v && v(v(C([])));
                        y && y !== e && n.call(y, a) && (g = y);
                        var b = w.prototype = p.prototype = Object.create(g);
                        ...
                        function _(t, e) {
                            var n = e.method,
                                i = t.iterator[n];
                            if (void 0 === i) return e.delegate = null, "throw" === n && t.iterator.return && (e.method = "return", e.arg = void 0, _(t, e), "throw" === e.method) || "return" !== n && (e.method = "throw", e.arg = new TypeError("The iterator does not provide a '" + n + "' method")), h;
                        ...
                        return m.prototype = w, i(b, "constructor", {
                            value: w,
                            configurable: !0
                        }), i(w, "constructor", {
                            value: m,
                            configurable: !0
                        }), m.displayName = l(w, u, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
                            var e = "function" == typeof t && t.constructor;
                            return !!e && (e === m || "GeneratorFunction" === (e.displayName || e.name))
                        }, t.mark = function(t) {
                            return Object.setPrototypeOf ? Object.setPrototypeOf(t, w) : (t.__proto__ = w, l(t, u, "GeneratorFunction")), t.prototype = Object.create(b), t
                        }, t.awrap = function(t) {
                            return {
                                __await: t
                            }
                        }, k(T.prototype), l(T.prototype, c, (function() {
                            return this
                        })), t.AsyncIterator = T, t.async = function(e, n, i, o, r) {
                            void 0 === r && (r = Promise);
                            var a = new T(d(e, n, i, o), r);
                    ...
                    return function(t, e, n) {
                        ...
                        value: function(t, e) {
                            ...
                            i.a.get("".concat("https://va.tawk.to", "/v1/widget-settings"), {
                                ...
                                }, n.languageScript.async = !0, n.languageScript.charset = "UTF-8", n.languageScript.src = "".concat("https://embed.tawk.to/_s/v4/app/65040be8d34", "/languages/").concat(o.data.widget.language, ".js")
                            }))
                        }
                    }, {
                        key: "processSettings",
                ...
                var E = function() {
                    function e() {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                            n = t.propertyId,
                            i = t.widgetId;
                        I(this, e), this.propertyId = n || window.$_Tawk_AccountKey, this.widgetId = i || window.$_Tawk_WidgetId
                    }
                    return function(t, e, n) {
                        ...
                        value: function() {
                            var e = this;
                            if (k.a.dispatch("reset"), k.a.dispatch("property/updateId", this.propertyId), k.a.dispatch("widget/updateId", this.widgetId), k.a.dispatch("property/updateIsTawkHostedPage", "tawk.to" === window.location.host), k.a.dispatch("router/addRoutes", S.a), new f.a(k.a), t.Tawk_Window.jsApi.local_API.isWindowed) {
            ...
            (function(t) {
                ...
                function a() {
                    ...
                    return m.prototype = w, i(b, "constructor", {
                        ...
                        value: m,
                        configurable: !0
                    }), m.displayName = l(w, c, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
                        var e = "function" == typeof t && t.constructor;
                        return !!e && (e === m || "GeneratorFunction" === (e.displayName || e.name))
                    }, t.mark = function(t) {
                        return Object.setPrototypeOf ? Object.setPrototypeOf(t, w) : (t.__proto__ = w, l(t, c, "GeneratorFunction")), t.prototype = Object.create(b), t
                    }, t.awrap = function(t) {
                        return {
                            __await: t
                        }
                    }, k(T.prototype), l(T.prototype, s, (function() {
                        return this
                    })), t.AsyncIterator = T, t.async = function(e, n, i, o, r) {
                        void 0 === r && (r = Promise);
                        var a = new T(d(e, n, i, o), r);
                    ...
                    }, k(b), l(b, c, "Generator"), l(b, r, (function() {
                        return this
                    })), l(b, "toString", (function() {
                        return "[object Generator]"
                    })), t.keys = function(t) {
                ...
                var h = function() {
                    ...
                    return function(t, e, n) {
                        ...
                        value: function(e, n) {
                            var i, o = this,
                                a = "".concat("https://va.tawk.to", "/v1/client/login"),
                                s = t.Tawk_Window.sessionManager.getStoredToken();
                            s && (i = {
                                "X-Tawk-Token": s
                            }), r.a.post(a, e, i, (function(e, i) {
                                if (e || !e && !i) return n(!0);
                                if (i.error) return n(i.error);
                                o.reconnectSession((function() {
                        ...
                        value: function(e) {
                            var n, i = this,
                                o = "".concat("https://va.tawk.to", "/v1/client/logout"),
                                a = t.Tawk_Window.sessionManager.getStoredToken();
                            a && (n = {
                                "X-Tawk-Token": a
                            }), r.a.post(o, {}, n, (function(n, o) {
                                if (n || !n && !o) return e(!0);
                                if (o.error) return e(o.error);
                                i.reconnectSession((function() {
                                    e(), t.Tawk_Window.eventBus.$emit("forceUpdate")
                                }))
                            }), !0, !0)
                        }
                    }]), e
        ...
        "9be8": function(t, e, n) {
            ...
            (function(t) {
                ...
                function a() {
                    ...
                    function T(t, e) {
                        function o(i, a, s, c) {
                            ...
                            if ("throw" !== u.type) {
                                var l = u.arg,
                                    d = l.value;
                                return d && "object" == r(d) && n.call(d, "__await") ? e.resolve(d.__await).then((function(t) {
                                    o("next", t, s, c)
                                }), (function(t) {
                                    o("throw", t, s, c)
                                })) : e.resolve(d).then((function(t) {
                    ...
                    }, k(b), l(b, u, "Generator"), l(b, s, (function() {
                        return this
                    })), l(b, "toString", (function() {
                        return "[object Generator]"
                    })), t.keys = function(t) {
                ...
                var s = function() {
                    ...
                    return function(t, e, n) {
                        ...
                        value: function() {
                            ...
                            }, window.Tawk_API.login = function() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                            ...
                            }, window.Tawk_API.logout = function(e) {
                        ...
                        function T(t, e) {
                            function r(i, a, s, c) {
                                ...
                                if ("throw" !== u.type) {
                                    var l = u.arg,
                                        d = l.value;
                                    return d && "object" == o(d) && n.call(d, "__await") ? e.resolve(d.__await).then((function(t) {
                                        r("next", t, s, c)
                                    }), (function(t) {
                                        r("throw", t, s, c)
                                    })) : e.resolve(d).then((function(t) {
        ...
        d046: function(t, e, n) {
            ...
            (function(t) {
                var i = [{
                    ...
                    path: "history-chat",
                    component: function() {
                        return Promise.all([n.e("chunk-4fe9d5dd"), n.e("chunk-2d0b9454"), n.e("chunk-2d0b383d"), n.e("chunk-0f6820a1")]).then(n.bind(null, "002e"))
                    },
                    hasBack: !0
                }, {
                    path: "agents",
        ...
        e8cc: function(t, e, n) {
            ...
            (function(t) {
                ...
                var p = function() {
                    ...
                    m = function() {
                        return Promise.all([n.e("chunk-4fe9d5dd"), n.e("chunk-2c78ba82"), n.e("chunk-2d0b9454"), n.e("chunk-2d0b383d"), n.e("chunk-07cad36d")]).then(n.bind(null, "d6a3"))
                    },
                    w = function() {
                        return Promise.all([n.e("chunk-2c78ba82"), n.e("chunk-f1596d96")]).then(n.bind(null, "0bdc"))
                    },
                    g = function() {
                        return Promise.all([n.e("chunk-2c78ba82"), n.e("chunk-2d0b383d"), n.e("chunk-48f46bef")]).then(n.bind(null, "6b5b"))
                    };
